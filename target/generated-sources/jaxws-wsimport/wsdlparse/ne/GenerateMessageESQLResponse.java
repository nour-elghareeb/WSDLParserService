 ...
 *       &lt;sequence>
 *         &lt;element name="ESQLLine" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GenerateMessageESQLResponse {
    ...
    @XmlElement(name = "ESQLLine", required = true)
    protected List<String> esqlLine;
     ...
     * 
     */
    public List<String> getESQLLine() {
        if (esqlLine == null) {
            esqlLine = new ArrayList<String>();
        }
